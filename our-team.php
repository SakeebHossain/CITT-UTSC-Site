        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Bilal">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Bilal Fasihi<br>
                            <small>Vice President of External Affairs</small>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Fiona">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Fiona Au<br>
                            <small>Vice President of Internal Affairs</small>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Hamna">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Hamna Khan<br>
                            <small>Vice President of Communications</small>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Rufaida">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Rufaida Hashmi<br>
                            <small>Publications Director</small>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Bisesh">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Bisesh Shrestha<br>
                            <small>Corporate Relations Director</small>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center" type="button" data-toggle="modal" data-target="#Judy">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Judy Elhaddad<br>
                            <small>Social Media Director</small>
                        </h3>
                    </div>
                </div>
            </div>
